...
import com.github.cheukbinli.original.cache.redis.JedisStandAloneFactory;
...
import com.github.cheukbinli.original.oauth.security.OauthAccessDecisionManager;
import com.github.cheukbinli.original.oauth.security.OauthAuthenticationProvider;
import com.github.cheukbinli.original.oauth.security.OauthFilterInvocationSecurityMetadataSource;
import com.github.cheukbinli.original.oauth.security.filter.LoginFilter;
import com.github.cheukbinli.original.oauth.security.filter.OauthBasicAuthenticationFilter;
...
public class WebSecurityConfigration extends WebSecurityConfigurerAdapter {
    ...
    @Value("${com.github.cheukbinli.original.oauth.login.url:/user/login}")
    private String loginUrl;

    @Value("${com.github.cheukbinli.original.oauth.login.page.url:/user/loginPage}")
